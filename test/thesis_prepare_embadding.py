...
problem = path_matlab + "thesis_problem.mat"
...
print("Embedding: coarsening and patches")
...
B_embed = fill_B(res, idx_fill, M.shape[0])
row_sums_embed = B_embed.sum(axis=1)
Q_embed = B_embed / row_sums_embed[:, np.newaxis]


np.save("../data/Q_embedded", Q_embed)
