...
B_virtual = fill_B(res, idx_fill, M.shape[0], mapp,C)
row_sums_virtual = B_virtual.sum(axis=1)
Q_virtual = B_virtual / row_sums_virtual[:, np.newaxis]

np.save("../data/Q_virtual", Q_virtual)
